...
<nav class="navbar navbar-expand-lg navbar-light"  style="background-color: #e3f2fd;">
  <a class="navbar-brand" href="#">CampusReservations</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      </li></ul><button class="btn btn-outline-primary" type="button" onclick="window.location='login.php'">Sign In</button>&nbsp;
        <button class="btn btn-outline-primary" type="button" onclick="window.location='create_user.php'">Register</button></div>
