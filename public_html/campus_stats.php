...
$query = "SELECT DISTINCT DAYName(StartDateTime), Count(LocID), LocName FROM Reservation NATURAL JOIN Location GROUP BY DAYNAME(StartDateTime), LocID";
